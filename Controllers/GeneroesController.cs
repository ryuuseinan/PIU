...
namespace PIU.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(PiuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Generos != null ? 
                          ...
                          Problem("Entity set 'PiuContext.Generos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Activo")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Activo")] Genero genero)
        {
            if (id != genero.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PiuContext.Generos'  is null.");
            }
            var genero = await _context.Generos.FindAsync(id);
            if (genero != null)
            {
